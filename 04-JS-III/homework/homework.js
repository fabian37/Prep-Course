...
function promedioResultadosTest(resultadosTest) {
	...
	// Tu código:
	// const sumaElementos = resultadosTest.reduce((acumulador, elemento)=> acumulador + elemento, 0)
	// const promedioResultados = sumaElementos/resultadosTest.length
...
function numeroMasGrande(numeros) {
	...
	// Tu código:
	// const masGrande = numeros.reduce((a, b) => Math.max(a,b),0)
	// return masGrande
	// Esta solucion es más corta pero falla con muchos elementos, es mejor usar reduce.
...
function mayorACien(array) {
	...
	// Tu código:
	// let newArray = array.filter(x=>x>100)
	// return newArray
	let newArray = [];
	for (let i = 0; i < array.length; i++) {
		if (array[i] > 100) {
